    ...
    <div className={aboutStyle.container}>
      ...
      <div className={aboutStyle.content}>
        <p>
          ...
          программирование, и уже спустя пару лет получил свою первую работу на
          Java. На канале вы найдете мой мыслительный процес через года, начиная
          от теоретических видео, где я делюсь своим опытом изучения compscie,
          вплоть до live-материалов на Java/C++ в tutorial-like стиле. Это моя
          история. Piece.
        </p>
      </div>
